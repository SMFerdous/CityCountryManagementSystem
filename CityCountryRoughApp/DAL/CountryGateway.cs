...
namespace CityCountryRoughApp.DAL
{
    public class CountryGateway
    {
        ...
        public List<Country> GetCountriesForView()
        {
            ...
            string query = "SELECT co.Id , co.Name as [CountryName],co.About as [About],ISNULL(COUNT(ci.Id),0) as [NoOfCities] , ISNULL(SUM(ci.NoOfDwellers),0) as [TotalNoOfDwellers] FROM Countries  as co LEFT OUTER Join  Cities as ci ON  co.Id =  ci.CountryId GROUP BY  co.Id,co.Name,co.About ORDER BY co.Name";
